...
public:
    ...
    void toastActivated(const std::wstring& arguments) const {
        std::wcout << L"The user request: " << arguments << std::endl;
        exit(1);
    }
...
int wmain(int argc, LPWSTR* argv)
{
    ...
    LPCWSTR appName = L"Console WinToast Example",
    ...
    templ.readFromFile("D:\\resources\\test\\ToastFromXML\\ToastFromXML\\test.xml");
